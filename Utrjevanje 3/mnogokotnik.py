...
def _validate_current_file():
    ...
    if Check.part():
        try:
            Check.equal('Mnogokotnik([(0, 0), (1, 0), (1, 1), (0, 1), (0, 0)]).oglisca', [(0, 0), (1, 0), (1, 1), (0, 1)])
            Check.equal('Mnogokotnik([(0, 0), (1, 0), (1, 1), (0, 1)]).oglisca', [(0, 0), (1, 0), (1, 1), (0, 1)])
            Check.equal('Mnogokotnik([(2, 0), (2, 1), (0, 2), (-2, 1), (-2, 0), (0, 1)]).oglisca', [(2, 0), (2, 1), (0, 2), (-2, 1), (-2, 0), (0, 1)])
            Check.equal('Mnogokotnik([(2, 0), (2, 1), (0, 2), (-2, 1), (-2, 0), (0, 1), (2, 0)]).oglisca', [(2, 0), (2, 1), (0, 2), (-2, 1), (-2, 0), (0, 1)])
        except:
    ...
    if Check.part():
        try:
            ...
            Check.equal('Mnogokotnik([(2, 0), (2, 1), (0, 2), (-2, 1), (-2, 0), (0, 1)]).obseg()', 10.94427190999916)
        except:
            Check.error("Testi sprožijo izjemo\n  {0}",
                        "\n  ".join(traceback.format_exc().split("\n"))[:-2])
    ...
    if Check.part():
        try:
            ...
            Check.equal('Mnogokotnik([(2, 0), (2, 1), (0, 2), (-2, 1), (-2, 0), (0, 1)]).ploscina()', 4.0)
            Check.equal('Mnogokotnik([(1, 0), (0.309017, 0.951057), (-0.809017, 0.587785), (-0.809017, -0.587785), (0.309017, -0.951057)]).ploscina()', 2.377641895659)
        except:
            Check.error("Testi sprožijo izjemo\n  {0}",
                        "\n  ".join(traceback.format_exc().split("\n"))[:-2])
    ...
    if Check.part():
        try:
            Check.equal('Mnogokotnik([(0, 0), (1, 0), (1, 1), (0, 1)]).je_konveksen()', True)
            Check.equal('Mnogokotnik([(2, 0), (2, 1), (0, 2), (-2, 1), (-2, 0), (0, 1)]).je_konveksen()', False)
            Check.equal('Mnogokotnik([(1, 0), (0.309017, 0.951057), (-0.809017, 0.587785), (-0.809017, -0.587785), (0.309017, -0.951057)]).je_konveksen()', True)
        except:
            Check.error("Testi sprožijo izjemo\n  {0}",
                        "\n  ".join(traceback.format_exc().split("\n"))[:-2])
