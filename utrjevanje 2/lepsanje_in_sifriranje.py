...
# abecedo.) Na primer iz besedila `'Attack at dawn!'` dobi besedilo
# `'ATTACKATDAWN'`. Nato ga zapiše cik-cak v treh vrsticah, kot prikazuje
# primer:
# 
#     A...C...D...
#     .T.A.K.T.A.N
#     ..T...A...W.
# 
# Sestavite funkcijo `cik_cak(s)`, ki vrne trojico nizov (torej `tuple`) in sicer prvo,
...
# Ker je Klodvik vaš dober prijatelj, mu boste pomagali in napisali
