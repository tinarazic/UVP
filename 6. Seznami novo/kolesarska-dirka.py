...
# Kolesarska dirka
#
# Gibanje kolesarja na dirki podamo s seznamov časov (v minutah), ki
# povedo, koliko časa je kolesar porabil za posamezno etapo. Dolžina
# seznama pove, koliko etap je kolesar prevozil.
# =====================================================================@001314=
# 1. podnaloga
...
# =====================================================================@001315=
# 2. podnaloga
# V spremenljivki `dirka` je zapisan seznam seznamov etapnih časov
...
# =====================================================================@001316=
# 3. podnaloga
# Dana sta dva (enako dolga) seznama časov po etapah. Funkcija
...
# =====================================================================@001317=
# 4. podnaloga
# Sestavite funkcijo `idealni_cas(dirka)`, ki za seznam seznamov časov
...
def _validate_current_file():
    ...
    if Check.part():
        try:
            Check.equal("statistika([14, 9, 23, 11, 7, 15])", (6, 79))
            Check.equal("statistika([14, 9, 23])", (3, 46))
            Check.equal("statistika([])", (0, 0))
            Check.equal("statistika([11, 13, 5, 8])", (4, 37))
            Check.equal("statistika([])", (0, 0))
        except:
    ...
    if Check.part():
        try:
            Check.equal("zmagovalec([[2, 1], [1, 2, 3], [6, 3, 1]])", (3, 1))
            Check.equal("zmagovalec([[2, 1, 2], [1, 2, 3], [6, 3, 1]])", (3, 0))
            Check.equal("zmagovalec([[2, 1, 2], [1, 2, 3], [5], [6, 3, 1]])", (3, 0))
            Check.equal("zmagovalec([[2, 1, 9, 4], [1, 2, 8, 4], [5], [6, 3, 1, 4]])", (4, 3))
        except:
            Check.error("Testi sprožijo izjemo\n  {0}",
                        "\n  ".join(traceback.format_exc().split("\n"))[:-2])
    ...
    if Check.part():
        try:
            Check.equal("primerjaj([3, 7, 4, 3], [5, 6, 3, 2])", (1, 0, 3))
            Check.equal("primerjaj([3, 7, 5, 2, 7, 4, 4, 3], [4, 6, 3, 2, 6, 3, 5, 4])", (3, 1, 4))
            Check.equal("primerjaj([2, 3, 3, 3], [3, 3, 3, 3])", (1, 3, 0))
            Check.equal("primerjaj([3, 3, 3, 3], [2, 3, 3, 3])", (0, 3, 1))
            Check.equal("primerjaj([3, 3, 3, 3], [3, 3, 3, 3])", (0, 4, 0))
        except:
            Check.error("Testi sprožijo izjemo\n  {0}",
                        "\n  ".join(traceback.format_exc().split("\n"))[:-2])
    ...
    if Check.part():
        try:
            Check.equal("idealni_cas([[2, 1], [1, 2, 3], [6, 3, 1]])", 3)
            Check.equal("idealni_cas([[2, 2], [1, 2, 3], [6, 3, 1]])", 4)
            Check.equal("idealni_cas([[2, 1], [1, 2, 3], [6, 3, 1], [5, 4, 2]])", 3)
        except:
            Check.error("Testi sprožijo izjemo\n  {0}",
                        "\n  ".join(traceback.format_exc().split("\n"))[:-2])
