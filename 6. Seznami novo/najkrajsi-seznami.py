...
def najkrajsi_neprazen_seznam(seznami):
    ...
    for seznam in seznami:
        if seznam and (najkrajsi is None or len(seznam)< len(najkrajsi)):
            najkrajsi=seznam
    return najkrajsi
# =====================================================================@001276=
# 3. podnaloga
...
def najkrajsi_vgnezden_seznam(seznam):
    if len(seznam)==0 or type(seznam[0])==int:
        ...
        nov=[]
        for x in seznam:
            najkrajsi=najkrajsi_vgnezden_seznam(x)
            nov.append(najkrajsi)
    return najkrajsi_seznam(nov)
...
def _validate_current_file():
    ...
    if Check.part():
        try:
            Check.equal('najkrajsi_seznam([])', None)
            Check.equal('najkrajsi_seznam([[3, 6], [17, 5, 2], [5], [6, 3]])', [5])
            Check.equal('najkrajsi_seznam([[1, 2], [], [4, 5, 6, 7]])', [])
        except:
    ...
    if Check.part():
        try:
            Check.equal('najkrajsi_neprazen_seznam([[], []])', None)
            Check.equal('najkrajsi_neprazen_seznam([[3, 6], [17, 5, 2], [5], [6, 3]])', [5])
            Check.equal('najkrajsi_neprazen_seznam([[1, 2], [], [4, 5, 6, 7]])', [1, 2])
        except:
            Check.error("Testi sprožijo izjemo\n  {0}",
                        "\n  ".join(traceback.format_exc().split("\n"))[:-2])
    ...
    if Check.part():
        try:
            Check.equal('najkrajsi_vgnezden_seznam([[[8, 9], [6, 7]], [[5], [4]], [1, 2, 3]])', [5])
            Check.equal('najkrajsi_vgnezden_seznam([[[[8, 9], [6, 7]], [[5], [4]], [1, 2, 3]]])', [5])
            Check.equal('najkrajsi_vgnezden_seznam([1, 2, 3])', [1, 2, 3])
            Check.equal('najkrajsi_vgnezden_seznam([[1, 2, 3], []])', [])
            Check.equal('najkrajsi_vgnezden_seznam([])', [])
            Check.equal('najkrajsi_vgnezden_seznam([[3, 6], [17, 5, 2], [5], [6, 3]])', [5])
            Check.equal('najkrajsi_vgnezden_seznam([[1, 2], [], [4, 5, 6, 7]])', [])
        except:
            Check.error("Testi sprožijo izjemo\n  {0}",
                        "\n  ".join(traceback.format_exc().split("\n"))[:-2])
