...
#     ('Vijolice', 'FMF 2015', 3, 1), ('Pitoni', 'Cicibani', 1, 1),
#     ('FMF 2015', 'Vijolice', 2, 1)]
# =============================================================================
...
# =====================================================================@002603=
# 2. podnaloga
# Sestavite funkcijo `rezultati(ime_datoteke)`, ki bo prebrala podatke o tekmah 
# iz datoteke z danim imenom ter sestavila in vrnila slovar, v katerem bodo 
# ključi imena ekip, vrednosti pa trojice, sestavljene iz števila doseženih 
# točk, števila odigranih tekem in razlike med številom danih in prejetih
# golov. Ekipa, ki na tekmi zmaga, dobi 3 točke, kadar pa je rezultat neodoločen,
# dobi vsaka ekipa po eno točko.
# 
#     >>> rezultati('nogomet.txt')
#     {'Rdeči vragi': (3, 3, 0), 'Pitoni': (3, 3, 0), 'Cicibani': (5, 3, 2),
#      'Vijolice': (3, 3, -1), 'FMF 2015': (3, 2, -1)}
# =============================================================================
def rezultati(ime_datoteke):
    slovar = {}
    for vrstica in open(ime_datoteke):
...
# =====================================================================@002604=
# 3. podnaloga
# Sestavite funkcijo `lestvica(ime_datoteke)`, ki bo prebrala podatke
# o tekmah iz datoteke z danim imenom ter sestavila in vrnila seznam parov,
# ki določa vrstni red ekip. Prvi element para je ime ekipe, drugi element
# pa število doseženih točk. Boljša ekipa je tista, ki ima več točk, če imamo
# več ekip z istim številom točk, je boljša tista z manj odigranimi tekmami,
# če je tudi takih več, izberemo ekipo z večjo razliko golov, zadnji od
# kriterijev pa je abecedni vrstni red.
# 
#     >>> lestvica('nogomet.txt')
#     [('Cicibani', 5), ('FMF 2015', 3), ('Pitoni', 3), ('Rdeči vragi', 3), ('Vijolice', 3)]
# =============================================================================
