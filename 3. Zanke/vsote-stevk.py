...
def vsota_vecjih_stevk(n,k=1):
    vsota_vecjih_stevk=0
    while n>0:
        if (n%10)>=k:
            vsota_vecjih_stevk+=n%10
        n=n//10
    return vsota_vecjih_stevk
# =====================================================================@000983=
# 3. podnaloga
...
def vsota_stevk_stevil_med(m,n):
    vsota_stevk_stevil_med=0
    for i in range(m,n+1):
        vsota_stevk_stevil_med+=vsota_stevk(i)
    return vsota_stevk_stevil_med
