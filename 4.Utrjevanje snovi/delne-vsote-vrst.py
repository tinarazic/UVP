...
def _validate_current_file():
    ...
    if Check.part():
        try:
            Check.equal('vsota_potenc(3, 4)', 98)
            Check.equal('vsota_potenc(4, 3)', 100)
            Check.equal('vsota_potenc(6, 6)', 67171)
        except:
    ...
    if Check.part():
        try:
            Check.equal('vsota_harmonicne(4)', 2.083333333333333)
            Check.equal('vsota_harmonicne(10)', 2.9289682539682538)
            Check.equal('vsota_harmonicne(40)', 4.278543038936376)
        except:
            Check.error("Testi sprožijo izjemo\n  {0}",
                        "\n  ".join(traceback.format_exc().split("\n"))[:-2])
    ...
    if Check.part():
        try:
            Check.equal('divergenca_harmonicne(3)', 11)
            Check.equal('divergenca_harmonicne(4)', 31)
            Check.equal('divergenca_harmonicne(5)', 83)
        except:
            Check.error("Testi sprožijo izjemo\n  {0}",
                        "\n  ".join(traceback.format_exc().split("\n"))[:-2])
    ...
    if Check.part():
        try:
            Check.equal('eksponentna(4)', 2.708333333333333)
