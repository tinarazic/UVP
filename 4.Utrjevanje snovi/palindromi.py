...
def skoraj_palindrom(niz):
    if palindrom(niz[1:-1]):
        return True
    for i in range(len(niz)):
        if palindrom(niz[:i]+niz[i+1:-i-1]+niz[-i:])or prakticno_palindrom(niz):
            return True
    return False
...
def _validate_current_file():
    ...
    if Check.part():
        try:
            Check.equal('palindrom("pericarezeracirep")', True)
    ...
    if Check.part():
        try:
            Check.equal('prakticno_palindrom("pericarežerackirep")', True)
            Check.equal('prakticno_palindrom("neragdodaren")', True)
            Check.equal('prakticno_palindrom("osemtermeso")', False)
            for i in range(100):
    ...
    if Check.part():
        try:
            Check.equal('skoraj_palindrom("pericarežerackirep")', True)
            Check.equal('skoraj_palindrom("neragdodaren")', True)
            
            Check.equal('skoraj_palindrom("osemtermeso")', True)
            
            Check.equal('skoraj_palindrom("tolezagotovoniskorajpalindrom")', False)
