...
def _validate_current_file():
    ...
    if Check.part():
        try:
            Check.equal("edit_distance('banana', 'ananas')", 2)
            Check.equal("edit_distance('potop', 'pokol')", 2)
            Check.equal("edit_distance('kitten', 'sitting')", 3)
            Check.equal("edit_distance('', 'banana')", 6)
            Check.equal("edit_distance('banana', '')", 6)
            Check.equal("edit_distance('', '')", 0)
            Check.equal("edit_distance('matematika', 'fizika')", 7)
            Check.equal("edit_distance('matematika', 'matematik')", 1)
            Check.equal("edit_distance('ananas', 'ananas')", 0)
            Check.equal("edit_distance('Saturday', 'Sunday')", 3)
        except:
